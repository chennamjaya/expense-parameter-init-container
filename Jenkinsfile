...
//      }
      steps {
        sh 'docker build -t 851512651356.dkr.ecr.us-east-1.amazonaws.com/expense-parameter-init-container:${TAG_NAME} .'
        ...
        sh 'docker push 851512651356.dkr.ecr.us-east-1.amazonaws.com/expense-parameter-init-container:${TAG_NAME}'
      }
    }
